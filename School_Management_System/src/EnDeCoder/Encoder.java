...
public class Encoder {
	...
	public static String typeEncode(String type){
    	...
    	public static String attendanceStatusEncode(String attendanceStatus){
		if(attendanceStatus.equals("ABSENT"))return "A";
		if(attendanceStatus.equals("PRESENT"))return "P";
