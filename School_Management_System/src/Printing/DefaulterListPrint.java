...
//                graphics.drawString("PRICE", 530+x, 46+z);
				...
				for(int i=0; i<5; i++){
                                  ...
                                  // if(bean == null) break;
                                graphics.drawString(""+i, 6, y+z);
				graphics.drawString("18CS", 100+x, y+z);
				graphics.drawString("ABC"+i, 180+x, y+z);
				graphics.drawString("XYZ"+i, 280+x, y+z);
				graphics.drawString("www"+i, 380+x, y+z);
                                y+=30;
            }
